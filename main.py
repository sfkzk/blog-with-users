...
class BlogPost(db.Model):
    ...
    # Create reference to the User object, the "posts" refers to the user_posts protperty in the User class.
...
class Comment(db.Model):
    ...
    # Create reference to the User object, the "comments" refers to the user_comments protperty in the User class.
    ...
    # Create reference to the BlogPost object, the "comments" refers to the post_comments protperty in the BlogPost class.
...
def edit_post(post_id):
    ...
    if edit_form.validate_on_submit():
        ...
        post.post_author = edit_form.post_author.data
